...
namespace Drupal\d8cards_day07\Plugin\QueueWorker;
...
class WelcomeMailSender extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    ...
    $module = 'd8cards_day07'; // ideally should be a config parameter but don't know how. Configuration is empty by design...
    $key = 'welcome_email';
